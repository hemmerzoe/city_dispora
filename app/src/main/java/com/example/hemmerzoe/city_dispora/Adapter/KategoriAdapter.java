    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            if(obj.getId_kategori().equals("1")) {
                url = "http://192.168.1.101/webcity_dispora/_upload/apotik/" + obj.getNama_gambar();
            }
            if(obj.getId_kategori().equals("2")) {
                url = "http://192.168.1.101/webcity_dispora/_upload/wisata/" + obj.getNama_gambar();
            }
            if(obj.getId_kategori().equals("3")) {
                url = "http://192.168.1.101/webcity_dispora/_upload/hotel/" + obj.getNama_gambar();
            }
            if(obj.getId_kategori().equals("4")) {
                url = "http://192.168.1.101/webcity_dispora/_upload/kuliner/" + obj.getNama_gambar();
            }
            if(obj.getId_kategori().equals("5")) {
                url = "http://192.168.1.101/webcity_dispora/_upload/perbankan/" + obj.getNama_gambar();
            }
            if(obj.getId_kategori().equals("6")) {
                url = "http://192.168.1.101/webcity_dispora/_upload/rumahsakit/" + obj.getNama_gambar();
            }
            Glide.with(ctx)
                    .load(url)
