...
public class AdapterListEvent extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private Context ctx;
    private AdapterListBerita.OnItemClickListener mOnItemClickListener;
    ...
    public void setOnItemClickListener(final AdapterListBerita.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }

    public AdapterListEvent(Context context, List<People> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof AdapterListBerita.OriginalViewHolder) {
            AdapterListBerita.OriginalViewHolder view = (AdapterListBerita.OriginalViewHolder) holder;
